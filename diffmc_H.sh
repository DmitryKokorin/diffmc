...
#     WORK_DIR=output-$(hostname)-equal_Kll-${h}T-32768x32768-01-e-pi_2-$(date +%Y%m%d)

#     OEPROFILE_FILE="oeprofile_${h}T_512x32768_equal_Kll.txt"
#     EOPROFILE_FILE="eoprofile_${h}T_512x32768_equal_Kll.txt"
#     EEPROFILE_FILE="eeprofile_${h}T_512x32768_equal_Kll.txt"
#     OFREEPATH_FILE="ofreepath_${h}T_equal_Kll.txt"
#     EFREEPATH_FILE="efreepath_${h}T_equal_Kll.txt"
#     ECHANNELPROB_FILE="echannel_ee_only.txt"

#     WORK_DIR=output-$(hostname)-equal_Kll_no_ea-${h}T-32768x32768-01-e-pi_2-$(date +%Y%m%d)

#     OEPROFILE_FILE="oeprofile_${h}T_512x32768_equal_Kll_no_ea.txt"
#     EOPROFILE_FILE="eoprofile_${h}T_512x32768_equal_Kll_no_ea.txt"
#     EEPROFILE_FILE="eeprofile_${h}T_512x32768_equal_Kll_no_ea.txt"
#     OFREEPATH_FILE="ofreepath_${h}T_equal_Kll_no_ea.txt"
#     EFREEPATH_FILE="efreepath_${h}T_equal_Kll_no_ea.txt"
#     ECHANNELPROB_FILE="echannel_ee_only.txt"

     WORK_DIR=output-$(hostname)-starkexp-${h}T-0.01-e-pi_2-$(date +%Y%m%d)-3

     OEPROFILE_FILE="oeprofile_${h}T_0.01_starkexp_3.txt"
     EOPROFILE_FILE="eoprofile_${h}T_0.01_starkexp_3.txt"
     EEPROFILE_FILE="eeprofile_${h}T_0.01_starkexp_3.txt"
     OFREEPATH_FILE="ofreepath_${h}T_starkexp_3.txt"
     EFREEPATH_FILE="efreepath_${h}T_starkexp_3.txt"
     ECHANNELPROB_FILE="echannel_${h}T_starkexp_3.txt"
